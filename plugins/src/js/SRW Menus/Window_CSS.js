...
Window_CSS.prototype.createAttributeBlock = function(attack, jumpAmount) {
	var content = "";
	content+="<div class='attribute_block'>";
	
	if(ENGINE_SETTINGS.USE_WEAPON_ATTRIBUTE){
		content+="<div class='attribute_block_entry scaled_width scaled_height scaled_text effectiveness described_element' data-jump='"+jumpAmount+"' data-type='attack' data-subtype='attribute' data-value=''>";
	...
	content+="<div class='attribute_block_entry scaled_width scaled_height scaled_text described_element' data-jump='"+jumpAmount+"' data-type='attack' data-subtype='effect' data-value=''>";
	if(attack.effects.length){
		content+="S";
	} 
	content+="</div>";
	content+="<div class='attribute_block_entry scaled_width scaled_height scaled_text described_element' data-jump='"+jumpAmount+"' data-type='attack' data-subtype='postMove' data-value=''>";
	...
	if(attack.isCounter){
		content+="<div class='attribute_block_entry scaled_width scaled_height scaled_text described_element' data-jump='"+jumpAmount+"' data-type='attack' data-subtype='usage' data-value='counter'>";
		content+="C";
	} else if(attack.isCombination){
		content+="<div class='attribute_block_entry scaled_width scaled_height scaled_text described_element' data-jump='"+jumpAmount+"' data-type='attack' data-subtype='usage' data-value='combination'>";
		content+="T";
	} else {
		content+="<div class='attribute_block_entry scaled_width scaled_height scaled_text described_element' data-jump='"+jumpAmount+"' data-type='attack' data-subtype='usage' data-value=''>";
	}
	content+="</div>";
	content+="<div class='attribute_block_entry scaled_width scaled_height scaled_text described_element' data-jump='"+jumpAmount+"' data-type='attack' data-subtype='particle' data-value=''>";
	...
	if(ENGINE_SETTINGS.ENABLE_TWIN_SYSTEM){
		content+="<div class='attribute_block_entry all scaled_width scaled_height scaled_text fitted_text described_element' data-jump='"+jumpAmount+"' data-type='attack' data-subtype='all' data-value=''>";
		if(attack.isAll){
			content+="ALL";
		} 
		content+="</div>";
